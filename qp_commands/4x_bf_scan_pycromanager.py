...
def copy_tif_files(projectsFolderPath, sampleLabel, imageType, subregion):
    ...
    ## orignal stiching using 368 files of 8MB each
    #if "4x" in imageType:
    #    TILES_LOCATION = r'D:\__Data\20240110_Mike_tissue_4x\strip_metadata'
    #else:
    #    TILES_LOCATION = r'D:\__Data\20240110_Mike_tissue_4x\strip_metadata'
    
    ## replacement for test with 4 files of 8MB each
    if "4x" in imageType:
        TILES_LOCATION = r'C:\Users\lociuser\Codes\temp'
    else:
        TILES_LOCATION = r'C:\Users\lociuser\Codes\temp'
