...
def is_pymmcore_plus_available():
    try:
...
class PycromanagerHardware(MicroscopeHardware):
    ...
    def __init__(self,  settings: sp_microscope_settings):
        if not is_pycromanager_available():
